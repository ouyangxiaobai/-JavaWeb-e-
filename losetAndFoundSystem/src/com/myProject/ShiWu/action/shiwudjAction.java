...
public class shiwudjAction extends HttpServlet {
	public void destroy() {
		destroy();
	}
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		if (action.equals("add")) {
			...
			model.setWaiXing(request.getParameter("WaiXing"));
			model.setOtherBiaoShi(request.getParameter("OtherBiaoShi"));
			model.setPhone(request.getParameter("Phone"));
			model.setUserId(Integer.parseInt(request.getParameter("UserId")));
			model.setBaoChou(request.getParameter("BaoChou"));
